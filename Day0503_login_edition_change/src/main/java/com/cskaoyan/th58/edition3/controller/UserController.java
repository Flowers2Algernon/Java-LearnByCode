package com.cskaoyan.th58.edition3.controller;
...
import com.cskaoyan.th58.edition3.service.UserService;
import com.cskaoyan.th58.edition3.service.UserServiceImpl1;
...
//        Integer code = UserJsonModel.register(new User(username, password));
    ...
    public void function(){
        ...
        //此时产品变更有两个选择方案，平时可能会不断从这两个方案中不断切换--每次切换都来注释掉另一个显然不显示，
        //所以分离出service层
        //在service层中定义一个接口，不同的方案直接实现该接口即可
